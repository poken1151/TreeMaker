...
void GLWidget::keyPressEvent(QKeyEvent *e)
{
    ...
    {
        Camera = CCamera(Vector3(250, 15, 0), Vector3(0, 15, 0), Vector3(0, 0, -1), Vector3(0, 1, 0));
        updateGL();
    }
    ...
    {
        Camera = CCamera(Vector3(0, 15, -250), Vector3(0, 15, 0), Vector3(-1, 0, 0), Vector3(0, 1, 0));
        updateGL();
    }
